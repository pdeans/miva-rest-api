...
class NoteController extends Controller
{
    ...
    {
        $this->api->func('NoteList_Load_Query');
    ...
    {
        $api_response = $this->api->func('Note_Insert')
            ->params($request->all())
            ->add()
            ->send();
    ...
    {
        $api_response = $this->api->func('Note_Update')
            ->params(array_merge(['Note_ID' => (int)$id], $request->all()))
            ->add()
            ->send();
    ...
    {
        $api_response = $this->api->func('Note_Delete')
            ->params(['Note_ID' => (int)$id])
            ->add()
            ->send();
